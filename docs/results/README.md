...
| Does live validity imply permission to release? | [Caller/callback counterexample](../../theory/acquisition-distinguishability.md#3-live-validity-does-not-determine-release-eligibility) | [Ownership CVE policy comparison](ownership-cve-case.md) |

...
source_git=${CBPF_KFUNC_SOURCE_GIT:-${TEMP_SOURCE}/cheri-ebpf-closure-linux-base/.git}
builder=${CBPF_KFUNC_BUILDER:-sha256:b4de3680a00e3ac68ccc56bd87131b97c1fffcd5e016c2d1a54d7e3386d9fc6e}
pahole_runtime=${CBPF_KFUNC_PAHOLE_RUNTIME:-${PRIOR_OWNERSHIP_EVIDENCE}/tools/pahole-runtime}
